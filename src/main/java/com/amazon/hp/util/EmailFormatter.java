...
public class EmailFormatter {
    ...
    public EmailFormatter(String subject, String sql, int rejectSlistIdx, int blockGroupIdx, String mailFrom,
            String mailTo, String replyTo, String errorsTo, int html, int encoding, String charset, String sDate,
            String tDate, int durationSet, int clickSet, int siteSet, int atcSet, String gubun, String gubun2, String rName,
