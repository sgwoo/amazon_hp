...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active amazon-desc" id="goods">
    		<h3>아마존카의 <span class="text-point">리스</span>는?</h3>
    		<p>고객이 원하는 차량을 구매하여 일정기간 대여해드리는 서비스이며, 유지 / 관리 / 정비 / 사고처리 등 차량관련 모든 서비스를 제공합니다.</p>
			<img src="/resources/images/lease_desc.png"/><br/>
			<br/>
			<table class="desc-table table-bordered">
				...
				<tr>
					<th>전 차종 이용 가능</th>					
					<td>
						<!-- 단, 일반승용 LPG차종은 제외(경차, 7~9인승, 승합의 경우에는 LPG차종도 이용가능) -->
					</td>
				</tr>
			</table>
   	</div>
    ...
    <div role="tabpanel" class="tab-pane amazon-desc" id="feature">
		 <h3>아마존카 <span class="text-point">리스의 특징</span>은?</h3> 
    ...
    <div role="tabpanel" class="tab-pane amazon-desc" id="advantage">
    	<h3>아마존카 <span class="text-point">리스의 이용장점</span>은?</h3> 
	    <table class="advantage-table">
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<ul>
	    				<li>차량구매에 비해 초기비용을 최소화할 수 있습니다.</li>
						<li>세금감면 효과가 있습니다.<!-- &nbsp;<span class="label label-default" data-toggle="modal" data-target="#effect-modal" style="cursor:pointer;">법인세 또는 소득세 절세 효과 상세보기</span> --></li>
	    			...
	    			<ul>
	    				<li>
	    					신차 구매시 자산과 부채가 동시에 증가하여 부채비율이 증가하는데 비해,<br/>
     						아마존카 리스 이용시 매월 내는 대여료만 비용처리 되므로 회사의 부채비율을 줄일 수 있습니다.
	    				</li>
	    				<li>
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<ul>
	    				...
	    				<li>차량번호는 렌터카와 달리 '허, '하', '호' 번호가 붙지 않습니다.</li>
	    			</ul>
	    		</td>
	    	</tr>
	    </table>
    ...
    <div role="tabpanel" class="tab-pane amazon-desc" id="requirement">
    	<h3><span class="text-point">리스</span>와 <span class="text-point">신차구매</span>를 비교하면?</h3> 
    	<table class="desc-table table-bordered">
			<thead>
				<tr>
					<th colspan="2" scope="cols">&nbsp;</th>
					<th scope="cols">신차구입</th>
					<th scope="cols">아마존카 리스</th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td>월대여료에 포함<br>사고유무에 따른 보험료 할인/할증 없음<br>(단, 수입차는 고객 보험요율에 따른 보험료 산정<br>사고 유무에 따라 보험료 할인/할증)</td>
				</tr>
				<tr>
    	...
    	<%-- <table class="desc-table table-bordered">
			...
			<tbody>
				<tr>
					<th rowspan="4" scope="row">비용절감</th>
					<th scope="row">초기비용</th>
					<td>초기비용 과다 소요<br />
					 	※할부구입시 까다로운 신용심사</td>
					<td>최소한의 초기 비용<br />
						※할부구입보다 신용평가 기준 및 절차간편
					</td>
				</tr>
				<tr>
					<th scope="row">세금감면</th>
					<td><span  class="text02">리스보다 손비처리 용이하지 않음</span> <br />
						<span  class="text02">·법인: 차량을 구입하여 차량을 지급할 경우  복잡하고 번거러운 일이 많음</span><br />
						<span  class="text02">·개인사업자: 고급차보유시 손비 인정받기 어려움</span></td>
					<td><span  class="text02">차량을 구입할 경우보다 손비처리 용이함</span><br />
						<span  class="text02">·법인: 회사 중역의 경우 급여대신 차량을 지급하면 세금감면효과 큼</span><br />
						<span  class="text02">·개인사업자: 소득세 절감효과</span><br />
					</td>
				</tr>
				<tr>
	...
	<!-- Modal -->
<div class="modal fade" id="effect-modal" tabindex="-1" role="dialog" aria-labelledby="monthrent-modal" aria-hidden="true">
	<div class="modal-dialog">
	   	<div class="modal-content">
	       	<div class="modal-header">
	       		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	       		<h4 class="modal-title" id="myModalLabel">세금 감면 효과</h4>
	     	</div>
	     	<div class="modal-body">
	     		<img src="/resources/images/tax_r.jpg"/>      
	   		</div>
