		...
		<div class="car-info">
			<table class="smart-info-table" style="width: 100% !important;">
				...
				<tbody>
					...
					<tr>
						<td>색상</td>
						<td id="colorText" style="padding-left: 18px !important; padding-right: 0px !important;"></td>
						<td class="text-right bold" style="padding-left: 0px !important;">
					...
					<tr class="last-row">
						...
						<td class="text-right" style="font-size: 17px; padding-left: 0px;"><span
						...
						<td colspan="2">
							<div>
								※보증금은 계약기간 만료 후 환불해 드립니다.<small>[보증금 100만원을 증액하면, 월대여료
									4,620원(VAT 포함)이 인하됩니다. (년리 5.5% 효과)]</small>
							</div>
						</td>
					</tr>
					<tr>
