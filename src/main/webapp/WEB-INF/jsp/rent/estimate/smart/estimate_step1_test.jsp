...
//	}
	...
	<div class="estimate-header" style="padding: 0px 25px 0px 25px !important; width: 100% !important;">
		<div class="process-tab" style="padding-top: 38px !important; width: 100% !important; padding-left: 0px !important; height: 100% !important;">
			...
			<div class="col-md-12 col-xs-12" style="padding: 45px 0px 0px 0px !important;">
				<div class="col-md-4 col-xs-4 process-item done" style="width: 33.33333% !important; padding: 15px 0px 0px 0px; font-size: 1.0em;">STEP 1<br>실시간 견적</div>
				<div class="col-md-4 col-xs-4 process-item" style="width: 33.33333% !important; padding: 15px 0px 0px 0px; font-size: 1.0em;">STEP 2<br>상담 요청</div>
				<div class="col-md-4 col-xs-4 process-item" style="width: 33.33333% !important; padding: 15px 0px 0px 0px; font-size: 1.0em;">STEP 3<br>상담 정보 확인</div>
			</div>
		</div>
	</div>
	<div class="estimate-body" style="width: 100% !important; padding: 0px 25px 0px 25px !important;">
		<div class="car-info">
			<table class="smart-info-table" style="width: 100% !important;">
				...
				<tbody>
					...
					<tr>
						<td colspan="4">차량 구분</td>
					</tr>
					<tr>
						<td colspan="4">
							<input type="radio" name="car-gubun" id="car-gubun-new" checked> <label for="car-gubun-new">신차</label>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="car-gubun" id="car-gubun-sh"> <label for="car-gubun-sh">재렌트/재리스</label>
						</td>
					</tr>
					<tr>
						<td colspan="4">제조사</td>
					...
					<tr>
						<td colspan="4">
							<select id="countrySelectBox" style="width: 35%; max-width: 128px;">
								<option value="1">국산</option>
								<option value="2">수입</option>
							</select> 
							<select id="compSelectBox" style="width: 63%; max-width: 220px;">
					...
					<tr>
						<td colspan="4">
							<div class="col-md-12 col-xs-12" style="padding: 5px 0px 5px 0px;">
								<select class="carNameSelectBox" style="max-width: 367px;">
							...
							<div class="col-md-12 col-xs-12" style="padding: 5px 0px 5px 0px;">
								...
								<input type="text" disabled	style="width: 57%; height: 33px; float: left; margin-left: 14px;" class="selectedCarDetail" />
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="4">선택차량</td>
					</tr>
					<tr class="carInfo-row">
						<td colspan="2">
							<span class="primary bold" style="font-size: 1.1em;" id="displayCarName"></span>
						</td>
					...
					<tr>
						<td colspan="2" id="colorText" style="padding-left: 18px !important; padding-right: 0px !important;"></td>
						<td colspan="2" class="text-right bold" style="padding-left: 0px !important;">
							(<span id="colorAmt-display" class="bold">0원</span>)
						</td>
					</tr>
					<tr class="color-hide-tr" style="display: none;">
						<td colspan="4">
					...
					<tr class="dcAmt-row" style="display: none;">
						<td colspan="4">제조사 D/C</td>
					</tr>
					<tr class="dcAmt-row" style="display: none;">
						<td colspan="4" class="text-right">
							-&nbsp;<span id="displayDcAmt" class="bold">0 원</span>
						</td>
						<%-- <td></td> --%>
					</tr>
					<tr class="tax-row" style="display: none;">
						<td colspan="2">개별소비세 감면액</td>
						<td colspan="2" class="text-right">
							-&nbsp;<span id="displayTaxDcAmt" class="bold">0 원</span>
						</td>
					</tr>
					<tr class="last-row">
						<%-- <td></td> --%>
						<td colspan="4" class="text-right bold" style="font-size: 17px;">
							차량가격 <span id="totalDisplayAmt" class="bold" style="padding-left: 10px;">0원</span><br>
							<span id="totalDisplayAmt-info" style="font-size: 14px;">
								( <span>제조사 D/C</span> <span>&nbsp;및&nbsp;</span>
						...
						<%-- <td class="text-right" style="font-size: 17px; padding-left: 0px;">
							<span id="totalDisplayAmt" class="bold">0원</span>
						</td> --%>
			...
			<table class="car-option-table" style="width: 100% !important;">
				...
				<tbody>
					...
					<tr>
						<td colspan="4">
							<div class="col-md-12 col-xs-12" style="padding: 0px;">
								...
								<input type="text" name="periodSelectBox" style="width: 48%; float: right;" disabled>
							</div>
							<div class="col-md-12 col-xs-12" style="padding: 0px;">
					...
					<tr>
						<td colspan="4">
							<div class="col-md-12 col-xs-12" style="padding: 0px;">
								...
								<input type="text" name="agreeDistSelectBox" value="" style="width: 48%; float: right;" disabled>
							</div>
							<div class="col-md-12 col-xs-12" style="padding: 0px;">
								※ 약정운행거리가 적을수록 대여요금이 저렴합니다.<br>
								※ 약정운행거리는 1,000km 단위로 견적가능합니다.
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr class="ecar-area" style="display: none;">
						<td>고객 주소지</td>
						<td>
							<select id="ecarLocationSelectBox" onchange="javascript:autoChangeRegionSel();">
			...
			<div class="col-md-12 col-xs-12 text-right" style="width: 100%; padding: 0px 0px 15px 0px;">
				<button type="button" class="calculate-btn" style="width:50% !important;" 
					data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> 견적 진행 중">견적 내기</button>
			</div>
			<!-- 전기차/수소차 제외 모든차량들 -->
							...
							<td rowspan="2" colspan="2">
								<div class="view_sellingOpt_on">
									...
									<span>매입옵션 가격(인수가)</span> <span class="estimate-price"
										style="margin-left: 50%;" id="sellingPrice">0원</span> <br />
