...
<div class="desc-container">
	...
	<div class="amazon-tabs">
		<a href="/utility/2017/domestic"><div class="amazon-tab">국산승용차</div></a>
		<a href="/utility/2017/rv"><div class="amazon-tab active">국산 RV차</div></a>
		...
		<div role="tabpanel" class="tab-pane" id="rv2">
			...
			<table class="table desc-table table-bordered">
				...
				<tbody>
					...
					<tr>
						<td class="text-center">8</td>
						<td class="">코란도 투리스모 9인승  2.0 디젤</td>
						<td class="text-center">경유</td>
						<td class="text-right">3020</td>
