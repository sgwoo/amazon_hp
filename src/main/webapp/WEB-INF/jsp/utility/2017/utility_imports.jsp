...
<div class="desc-container">
	...
	<div class="amazon-tabs">
		...
		<a href="/utility/2017/imports"><div class="amazon-tab active">수입차</div></a>
	</div>
	<BR/>
	<!-- Nav tabs -->
			...
			<table class="table desc-table table-bordered">
				...
				<tbody>	
					...
					<tr>
						...
						<td>닛산 Altima 2.5 SL Smart 가솔린</td>
						<td class="text-center">휘발유</td>
		...
		<div role="tabpanel" class="tab-pane" id="2">
			...
			<table class="table desc-table table-bordered">
				...
				<tbody>
					...
					<tr>
						<td class="text-center">1</td>
						<td>아우디 The new A6 40 TDI 콰트로 Comfort</td>
						<td class="text-center">경유</td>
					...
					<tr>
						<td class="text-center">13</td>
						<td>아우디 The new Q7 35 TDI 콰트로 Comfort</td>
						<td class="text-center">경유</td>
